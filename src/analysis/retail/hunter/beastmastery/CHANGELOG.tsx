...
export default [
  ...
  change(date(2023, 1, 30), <>Added cooldown efficiency bars for <SpellLink spell={TALENTS.BESTIAL_WRATH_TALENT}/>, Death Chakram, <SpellLink spell={TALENTS.BLOODSHED_TALENT} /> and <SpellLink spell={TALENTS.DIRE_BEAST_TALENT} /> to the guide.</>, Putro),
  ...
  change(date(2023, 1, 20), <>Separated <SpellLink spell={SPELLS.DIRE_BEAST_BUFF}/> uptime attribution into <SpellLink spell={TALENTS.DIRE_BEAST_TALENT} /> and Dire Pact.</>, Putro),
